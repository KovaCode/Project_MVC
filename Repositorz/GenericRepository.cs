...
{
    public class Repository : IRepositoryMake<IEntity>
    {
        ...
        {
            this.context = contextObj ?? throw new ArgumentNullException("context");
        }
        ...
        public TEntity GetByKey<TEntity>(Guid keyValue) where TEntity : class
        {
            EntityKey key = GetEntityKey<TEntity>(keyValue);

            if (((IObjectContextAdapter)DbContext).
            ObjectContext.TryGetObjectByKey(key, out object originalItem))
            {
